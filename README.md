...
<sup id="f1">[1](#s1)</sup> <sub>Yes, it's not actually "countably infinite". But with the normal 9x9 Sudoku having [6,670,903,752,021,072,936,960](https://en.wikipedia.org/wiki/Mathematics_of_Sudoku#Enumerating_Sudoku_solutions "Wikipedia: Mathematics of Sudoku") possible configurations, I'd say the 25x25 is close enough.</sub>
